...
m1 = Brand.last.models.create(model_name: 'A4')
m2 = Brand.first.models.create(model_name: 'M3')
...
Car.create(model_id: m1.id, mileage: 2000, registration_no: "KR1234", year_of_manufacture: 2000)
Car.create(model_id: m2.id, mileage: 23000, registration_no: "WW1234", year_of_manufacture: 2012)
